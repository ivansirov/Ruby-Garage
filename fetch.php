...
$columns = array('name', 'priority', 'status', 'project_id');
...
{ $sub_array = array();
 ...
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="priority">' . $row["priority"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="status">' . $row["status"] . '</div>';
 $sub_array[] = '<div contenteditable class="update" data-id="'.$row["id"].'" data-column="project_id">' . $row["project_id"] . '</div>';
